defmodule Gatehouse.ACME.Config do
  @moduledoc """
  Converts static proxy config into ACME renewal jobs.
  """

  alias Gatehouse.Config
  alias Gatehouse.Config.Service
  alias Gatehouse.TLS.SNI

  @default_cert_directory "/var/lib/gatehouse/certs"
  @default_account_directory "/var/lib/gatehouse/acme"
  @default_provider Gatehouse.ACME.Provider.ExAcme
  @default_store Gatehouse.CertificateStore.File
