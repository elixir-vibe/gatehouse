defmodule Gatehouse.Config do
  @moduledoc """
  Minimal Caddy-like Elixir DSL for static `gatehouse` configuration.
  ...
  alias Gatehouse.Config.{Builder, Listener, Service, Target}
  ...
  def eval!(source) when is_binary(source) do
    Builder.run(fn -> Code.eval_string(source, [], file: "gatehouse_config.exs") end)
  end
