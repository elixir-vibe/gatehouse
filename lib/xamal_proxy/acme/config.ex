defmodule XamalProxy.ACME.Config do
  ...
  defp service_job(%Service{} = service, acme) do
    ...
    cert_directory = Keyword.get(acme, :cert_directory, @default_cert_directory)
    ...
    %{
      ...
      store: Keyword.get(acme, :store, @default_store),
      store_opts: Keyword.get(acme, :store_opts, directory: cert_directory),
