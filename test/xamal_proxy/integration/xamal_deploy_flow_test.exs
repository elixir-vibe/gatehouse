defmodule XamalProxy.Integration.XamalDeployFlowTest do
  use ExUnit.Case, async: false

  test "simulates Xamal blue-green deploy calls against xamal_proxy" do
    {:ok, blue} =
    ...
    {:ok, listener} =
      XamalProxy.LiveryListener.start_link(port: 0, name: unique_name(:xamal_proxy))
