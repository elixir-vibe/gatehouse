defmodule XamalProxy.TelemetryTest do
  ...
  test "deploy emits telemetry" do
    ...
    :telemetry.detach("xamal-proxy-deploy-test")

    :telemetry.attach(
      "xamal-proxy-deploy-test",
    ...
    assert_receive {^ref, [:xamal_proxy, :deploy, :stop], %{duration: duration}, metadata}
